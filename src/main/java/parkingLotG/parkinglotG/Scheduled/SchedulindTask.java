package parkingLotG.parkinglotG.Scheduled;
...
@Component
public class SchedulindTask {


    @Autowired
    private responseRepository tdrepository;

    @Scheduled(fixedRate = 120000) // 1분(60초)마다 실행
    public void fetchDataAndUpdateDatabase() throws IOException, ParseException, org.json.simple.parser.ParseException {
